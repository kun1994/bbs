...
{
		var temp = '';
	  temp += '<div style="float: left;height: 430px;width: 8px;background-image: url("__IMG__/bg_3.jpg");"></div>';
    temp += '<div style="font-family: Tahoma;text-align:left;float: left;height: 430px;width: 534px;background-image: url("__IMG__/bg_3.jpg");background-repeat: no-repeat;">';
    temp += '<div><h1 style="float:left;font-size: 14px;color: #FFFFFF;margin: 0px;padding: 10px 0 13px 2px;line-height:17px;">'+companyname+'</h1><a href="#" onclick="kf_hidekfpopup();return false;" style="background-image: url("__IMG__/close.gif");float: right;height: 19px;width: 40px;" onmouseover="javascript:this.style.backgroundPosition=\'bottom\'" onmouseleave="javascript:this.style.backgroundPosition=\'top\'"></a></div>';
    ...
    temp += '<a onclick="kf_hidekfpopup();return false;" href="#" style="float:left;background-image: url("__IMG__/btn_5.gif");margin:223px 0 0 28px;_margin-top:206px;margin-left:65px;padding: 0px;border:0px;height: 50px;width:132px;display:inline; "></a>';
<!--    temp += '<a onclick="kf_openChatWindow(1)" href="#" style="float:left;background-image: url("__IMG__/btn_3.gif");margin:155px 0 0 8px;_margin-top:140px;padding: 0px;border:0px;height: 55px;width:161px;"></a>';-->
	temp += '<a href="http://cnrdn.com/iP66" onclick="kf_openChatWindow();return false;" target="_blank" style="float:left;background-image: url("__IMG__/btn_4.gif");margin: 223px 0 0 10px;_margin-top:206px;margin-left:110px;padding: 0px;border:0px;height: 50px;width:161px;display:inline;"></a></div>';
    temp += '</div><div style="float: left;height: 430px;width: 8px;background-image: url("__IMG__/bg_3.jpg");background-position: right;"></div>';
	//alert(temp)
    return temp;
}
